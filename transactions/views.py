...
class SupplierDeleteView(View):
    ...
    def post(self, request, pk):  
        supplier = get_object_or_404(Supplier, pk=pk)
        supplier.delete()    # Llama al método delete() del objeto supplier para eliminarlo de la base de datos                                              
    ...
    def post(self, request, pk):
        ...
        if formset.is_valid():
            ...
            for form in formset:                                                # for loop to save each individual form as its own object
                ...
                stock.save()
                billitem.save()
            messages.success(request, "Los artículos comprados se han registrado correctamente")
